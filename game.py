...
while running:
    ...
    if not game_over:
        ...
        pollution_text = font.render(f"Pollution level: {pollution_level}", True, WHITE)
        ...
        if pollution_level < 30:
            ...
            screen.blit(keep_going, (400, 300))
    ...
    if pollution_level <= winning_pollution_level:
        ...
        restart_text = font.render("Click or press any key to restart", True, (255, 255, 255))
